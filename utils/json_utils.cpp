...
construirRespuestaJsonXFastTrie(const std::string &palabraBuscada,
  ...
  for (size_t i = 0; i < skipped.size(); ++i) {
    ...
    const std::string &word = skipped[i];
    salida << "{";
    salida << "\"palabra\":\"" << escaparJson(word) << "\"";
    salida << "}";
  }
  ...
  for (size_t i = 0; i < resultados.size(); ++i) {
    ...
    const std::string &resultado = resultados[i];
    salida << "{";
    salida << "\"palabra\":\"" << escaparJson(resultado) << "\"";
    salida << "}";
  }
